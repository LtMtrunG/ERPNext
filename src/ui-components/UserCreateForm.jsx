...
export default function UserCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setCurrentEventIDValue("");
    setErrors({});
  };
  const [currentEventIDValue, setCurrentEventIDValue] = React.useState("");
  ...
  return (
    ...
    >
      ...
      <ArrayField
        ...
        setFieldValue={setCurrentEventIDValue}
